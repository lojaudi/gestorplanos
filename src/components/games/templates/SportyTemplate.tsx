  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" style={{
        background: "radial-gradient(ellipse at 50% 0%, rgba(255,255,255,0.1) 0%, transparent 55%)",
      }} />
      <div className="absolute inset-0" style={{
        background: "linear-gradient(180deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.05) 50%, rgba(0,0,0,0.25) 100%)",
      }} />
      ...
      <div className="relative z-10 flex h-full">
        ...
        <div className="relative" style={{ width: "38%", overflow: "hidden" }}>
          ...
          {backgroundUrl ? (
            ...
            <div className="absolute inset-0" style={{
              background: `linear-gradient(180deg, ${primaryColor}30, ${accentColor}15)`,
            }} />
          )}
